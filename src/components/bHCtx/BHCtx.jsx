...
import {calculateTime, changeTimeFormat, formatTime, getCurrentTime, getMovementsAverage } from "../../helpers/date"
...
import BHCtr from "./BHCtr"
import { getFrequency } from "../../helpers/arrayHelpers"

const BHCtx = ({preg}) => {
  const {id} = preg
  const [isRunning, setIsRunning] = useState(false)
  const {errorsOrMessages,dispatch,bhctr, bhctx, bhctxLoading } = useContext(PregnancyContext)
